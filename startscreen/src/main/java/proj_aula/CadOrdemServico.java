...
public class CadOrdemServico extends JInternalFrame{
     ...
     JTextField CodFunc_txt, CodCli_txt, CodVel_txt, Valor_txt;
	 ...
	 Obs_txt.setBounds(320,160,224,60);
	 ...
	 limpar.setBounds(20,250,120,25);
	 limpar.setFont(new Font("Century Gothic", 1, 15));
	 cadastrar.setBounds(160,250,120,25);
	 cadastrar.setFont(new Font("Century Gothic", 1, 15));
	 fechar.setBounds(300,250,120,25);
