...
import java.text.*;
public class ConsCli extends JInternalFrame{
	JButton fechar, pesquisar;
	JLabel pesqpor;
	JComboBox parpesq;
	String campos[] = {"Código", "Tipo de Pessoa", "Nome", "CPF", "RG", "Telefone Residencial", "Telefone Celular", "E-mail", "Data de Nascimento", "Endereço","Número da Residência","CEP","UF","Bairro","Cidade"};
	JTextField pesq_txt;
	ImageIcon pesq;
	public ConsCli() {
