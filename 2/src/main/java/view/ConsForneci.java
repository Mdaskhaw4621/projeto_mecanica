...
import java.text.*;
public class ConsForneci extends JInternalFrame{
	JButton fechar, pesquisar;
	JLabel pesqpor;
	JComboBox parpesq;
	String campos[] = {"ID do Fornecimento", "ID do Produto","ID do Fornecedor ","Data de Entrega","Valor"};
	JTextField pesq_txt;
	ImageIcon pesq;
	public ConsForneci() {
		super("Consulta de Fornecimentos");
